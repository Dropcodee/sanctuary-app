<div class="modal fade" id="update-department-{{ $exco->id }}" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Exco</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </a>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{ route('update-exco', $exco->id) }}">
                    @method('PATCH')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="dept_college" name="dept_college" required>
                            <option value="{{ $department->college }}" selected>{{ strtoupper($department->college) }}</option>}
                            option
